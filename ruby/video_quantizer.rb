# NOTE refactor ugly code, make composite classes
...
private
  ...
  def add_song
    ...
    "ffmpeg -i videos/output.mp4 -i #{path_to_song} -c:v copy \
     -map 0:v:0 -map 1:a:0 -shortest -af 'afade=in:st=0:d=#{fade_time}, \
     afade=out:st=#{video_duration_seconds-3}:d=#{fade_time}' \
     videos/output_with_music.mp4"
